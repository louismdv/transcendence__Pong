...
// livechat.js - espace de discussion privée en one to one permet dechanger via websockets
...
(function() {
    ...
    // Attacher des écouteurs d'événements (openChat) aux (message button) des fils de discussions (.contact-item)
