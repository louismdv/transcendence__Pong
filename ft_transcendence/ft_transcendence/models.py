...
class UserProfile(models.Model):
    ...
    avatar = models.ImageField(
        ...
        null=True,
        blank=True,
        default='../static/assets/avatars/default.png'
    )
    ...
    def get_avatar_url(self):
        ...
        return '/static/assets/avatars/default.png'
...
class GameRoom(models.Model):
    user = models.ForeignKey(
        User, related_name='game_rooms', on_delete=models.CASCADE)
    opponent = models.ForeignKey(
        User, related_name='opponent_rooms', on_delete=models.CASCADE, null=True, blank=True)
    winner = models.ForeignKey(
        User, related_name='games_won', on_delete=models.CASCADE, null=True, blank=True)
